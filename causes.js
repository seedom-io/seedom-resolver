...
const backgroundUrlTemplate = 'https://raw.githubusercontent.com/seedom-io/seedom-assets/master/causes/backgrounds/{image}.png';
...
module.exports.getBackgroundUrl = (image) => backgroundUrlTemplate.replace('{image}', image);
